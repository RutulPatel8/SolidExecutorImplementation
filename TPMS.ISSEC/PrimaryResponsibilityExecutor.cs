...
namespace TPMS.ISSEC
{
    ...
    public class PrimaryResponsibilityExecutor : IPrimaryResponsibilityExecutor
    {
        ...
        {
            Console.WriteLine("ISSEC Primary GetTaskResponsibility implementation");
        ...
        {
            Console.WriteLine("ISSEC Primary GetSubTaskResponsibility implementation");
        ...
        public manager GetProjectResponsibility(string externalUniqueId, Resource resource, double? currentStageSequence = 0.0, string currentStageSuccessorStage = null)
        {
            ...
            Console.WriteLine("ISSEC Primary GetProjectResponsibility implementation");
